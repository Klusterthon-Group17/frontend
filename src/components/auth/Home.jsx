    ...
    <Container className='my-10'>
      <div className='grid grid-cols-1 gap-10 items-center md:grid-cols-2'>
        ...
        <div className='-mt-60 bg-Body text-center py-14 space-y-5 md:-mt-0 md:py-0'>
          ...
          <div>
            <h1 className=' text-4xl font-bold md:text-6xl'>Let’s Take Care</h1>
            <h1 className=' text-4xl font-bold md:text-6xl'>of You</h1>
          </div>
          <h4 className='w-full mx-auto md:w-[85%]'>
